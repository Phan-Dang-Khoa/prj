...
public class DictionaryCommandline {
    ...
    public void dictionaryAdvanced() {
        String inFile = "D:\\OOP\\Dictionary\\src\\com\\example\\data\\dictionaries.txt";
    ...
    public static void main(String[] args) {
        ...
        //dictionaryManagement.dictionaryExportToFile(dictionary, "D:\\OOP\\Dictionary\\src\\com\\example\\data\\dictionaries.txt");
        //dictionaryCommandline.dictionaryAdvanced();

        dictionaryCommandline.showAllWords();
        ArrayList searcher = dictionaryCommandline.dictionarySearcher("Ho");

        for(int i = 0; i < searcher.size(); i++) {
            System.out.println(searcher.get(i));
        }
    }
}
